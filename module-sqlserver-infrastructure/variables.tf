...
locals {
  ...
  georedundant_enabled     = var.georedundant_enabled != null ? var.georedundant_enabled : (data.azurerm_resource_group.rg.tags.environment != "qas" && data.azurerm_resource_group.rg.tags.environment != "dev")
